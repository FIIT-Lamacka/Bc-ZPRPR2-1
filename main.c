...
int find_word(char slovo[],int slovo_len, int *coord[], char *array[], int height, int lenght, int count[]){
    ...
    for(j=0;j<count[prve_p];j+=2){
        ...
        //SEVERO-ZAPAD
        if(coord_y-slovo_len+1>=0&&coord_x+slovo_len<=lenght){
            for(i=1;i<slovo_len;i++){
                if(toupper(array[coord_y-i][coord_x+i])==slovo[i])
                    ;
                else
                    break;
            }
        ...
        //JUHO-ZAPAD
        if(coord_y+slovo_len<=height&&coord_x+slovo_len<=lenght){
            for(i=1;i<slovo_len;i++){
                if(toupper(array[coord_y+i][coord_x+i])==slovo[i])
                    ;
                else
        ...
        //JUHO-VYCHOD
        if(coord_y+slovo_len<=height&&coord_x-slovo_len+1>=0){
            for(i=1;i<slovo_len;i++){
                if(toupper(array[coord_y+i][coord_x-i])==slovo[i])
                    ;
                else
        ...
        if(coord_y-slovo_len+1>=0&&coord_x-slovo_len+1>=0){
            for(i=1;i<slovo_len;i++){
                if(toupper(array[coord_y-i][coord_x-i])==slovo[i])
                    ;
                else
